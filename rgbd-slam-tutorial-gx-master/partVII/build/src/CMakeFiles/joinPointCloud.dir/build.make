...
../bin/joinPointCloud: /usr/local/lib/libboost_system.so
../bin/joinPointCloud: /usr/local/lib/libboost_filesystem.so
../bin/joinPointCloud: /usr/local/lib/libboost_thread.so
../bin/joinPointCloud: /usr/local/lib/libboost_date_time.so
../bin/joinPointCloud: /usr/local/lib/libboost_iostreams.so
../bin/joinPointCloud: /usr/local/lib/libboost_serialization.so
../bin/joinPointCloud: /usr/local/lib/libboost_chrono.so
../bin/joinPointCloud: /usr/local/lib/libboost_atomic.so
../bin/joinPointCloud: /usr/local/lib/libboost_regex.so
