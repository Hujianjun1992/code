...
../bin/generate_pointcloud: /usr/local/lib/libboost_system.so
../bin/generate_pointcloud: /usr/local/lib/libboost_filesystem.so
../bin/generate_pointcloud: /usr/local/lib/libboost_thread.so
../bin/generate_pointcloud: /usr/local/lib/libboost_date_time.so
../bin/generate_pointcloud: /usr/local/lib/libboost_iostreams.so
../bin/generate_pointcloud: /usr/local/lib/libboost_serialization.so
../bin/generate_pointcloud: /usr/local/lib/libboost_chrono.so
../bin/generate_pointcloud: /usr/local/lib/libboost_atomic.so
../bin/generate_pointcloud: /usr/local/lib/libboost_regex.so
