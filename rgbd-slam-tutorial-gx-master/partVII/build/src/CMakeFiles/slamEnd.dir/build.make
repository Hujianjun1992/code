...
../bin/slamEnd: /usr/local/lib/libboost_system.so
../bin/slamEnd: /usr/local/lib/libboost_filesystem.so
../bin/slamEnd: /usr/local/lib/libboost_thread.so
../bin/slamEnd: /usr/local/lib/libboost_date_time.so
../bin/slamEnd: /usr/local/lib/libboost_iostreams.so
../bin/slamEnd: /usr/local/lib/libboost_serialization.so
../bin/slamEnd: /usr/local/lib/libboost_chrono.so
../bin/slamEnd: /usr/local/lib/libboost_atomic.so
../bin/slamEnd: /usr/local/lib/libboost_regex.so
